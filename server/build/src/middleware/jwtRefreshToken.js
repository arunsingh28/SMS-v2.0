...
function refreshToken(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var refresh_token, foundUser;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    refresh_token = (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.jwt;
                    if (!refresh_token)
                        return [2 /*return*/, res.sendStatus(401)
                            // find token in DB
                        ];
                    return [4 /*yield*/, user_model_1.default.findOne({ refresh_token: refresh_token }).exec()
